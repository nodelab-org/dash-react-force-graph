...
- nodeIdsHighlight (list of strings; optional): ids of highlighted nodes (through search)
- nodeIdsVisible (list of strings; optional): ids of visible nodes
- linkIdsHighlight (list of strings; optional): ids of highlighted links (through search)
