...
Graph2Dalt.propTypes = graphSharedProptypes

objSharedProps.id = "Graph2Dalt"

Graph2Dalt.defaultProps = objSharedProps;

export default withSizeHOC(Graph2Dalt)
