...
export dash_graph2d_tmp

"""
    dash_graph2d_tmp(;kwargs...)
...
"""
function dash_graph2d_tmp(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dash_graph2d_tmp", "Graph2D_tmp", "dash_react_force_graph", available_props, wild_props; kwargs...)
end
