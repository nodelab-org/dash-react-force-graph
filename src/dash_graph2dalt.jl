...
export dash_graph2dalt

"""
    dash_graph2dalt(;kwargs...)
...
"""
function dash_graph2dalt(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dash_graph2dalt", "Graph2Dalt", "dash_react_force_graph", available_props, wild_props; kwargs...)
end
