...
export dash_graph2d_original

"""
    dash_graph2d_original(;kwargs...)
...
- `n_rightClicks` (Real; optional)
"""
function dash_graph2d_original(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dash_graph2d_original", "Graph2D_original", "dash_react_force_graph", available_props, wild_props; kwargs...)
end
